        ...
        <div className="flex-1 p-10">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center mb-4">
              ...
              <h1 className="text-2xl font-bold">RECURRING DEPOSIT DETAILS</h1>
            </div>
...
export default MyBankInvestment;
