...
const PPFdashboard = () => {
    ...
    <div className="min-h-screen bg-[#0D1520] text-white flex">
      ...
      <div className="flex-1 flex flex-col bg-[#0D1520] ml-60">
        ...
        <div className="flex-1 p-6 space-y-6">
          <h1 className="text-2xl font-bold"> MY PPF INVESTMENTS </h1>
  ...
  <div className="bg-[#1B2735] p-4 rounded-lg flex justify-between items-start">
    <div>
      <p className="text-sm text-gray-400">Total PPF Balance</p>
  ...
  <div className="bg-[#1B2735] p-4 rounded-lg flex justify-between items-start">
    <div>
      <p className="text-sm text-gray-400">Next Contribution Due</p>
...
<div className="border border-gray-400 rounded-md w-full bg-[#1E293B]">
  ...
  <div className="p-4 space-y-4 text-white rounded-b-md">
    <div className="flex items-center space-x-3">
      ...
      <span className="font-medium">Self Account(60%)</span>
    </div>
    <div className="flex items-center space-x-3">
      <div className="w-6 h-6 rounded bg-[#F7B36B]" />
      <span className="font-medium">Spouse Account(25%)</span>
    </div>
    <div className="flex items-center space-x-3">
      <div className="w-6 h-6 rounded bg-[#F59C6B]" />
      <span className="font-medium">Children (15%)</span>
    </div>
  </div>
</div>
      </div>
  ...
  <div className="bg-[#1e293b] p-6 rounded-xl shadow overflow-x-auto">
    <ul className="space-y-4">
      <li className="flex items-start gap-3">
        ...
        <div>
          <p className="font-semibold">Contribution Reminder</p>
          <p className="text-gray-300">
            Your next yearly contribution is due on 15 June.
          </p>
      ...
      <li className="flex items-start gap-3">
        ...
        <div>
          <p className="font-semibold">Maturity Notice</p>
          <p className="text-gray-300">
            PPF account for Mrs. Nita Doshi is maturing in 2026!
          </p>
