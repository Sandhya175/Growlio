...
import PropertiesPortfolioPerformanceGraph from '../components/PropertiesPortfolioPerformanceGraph';
    ...
    <div className="min-h-screen bg-[#0D1520] text-white flex">
      ...
      <div className="flex-1 flex flex-col bg-[#0D1520] ml-60">
        ...
        <div className="flex-1 p-6 space-y-6">
          <h1 className="text-2xl font-bold"> MY PROPERTIES INVESTMENTS </h1>
        ...
        <p className="text-lg font-semibold text-white">₹ 15,00,000</p>
          ...
          <button className="bg-[#1f2937] text-white px-2 py-1 rounded">10Y</button>
            ...
            <div className="w-full h-74 bg-gradient-to-b from-[#1B2735] to-[#0D1520] rounded-lg p-4">
              <PropertiesPortfolioPerformanceGraph />
    ...
    <table className="w-full text-left text-sm">
      <thead className="bg-[#1B2735] text-gray-400">
        <tr className="border-b border-gray-600">
          <th className="p-3">Name of Seller</th>
          <th className="p-3">Name of Buyer</th>
      ...
      <tbody className="bg-[#1B2735]">
        <tr className="border-b border-gray-700">
          ...
          <td className="p-3">Mr. Rahul</td>
          <td className="p-3">Flat</td>
          <td className="p-3">₹ 45,280.67</td>
          <td className="p-3">₹ 89,990,000</td>
          <td className="p-3">April 5, 2025</td>
        </tr>
        <tr>
          <td className="p-3 font-medium">Mr. Bankim Doshi</td>
          <td className="p-3">Mr. Joshi</td>
          <td className="p-3">Flat</td>
          <td className="p-3">₹ 45,280.67</td>
          <td className="p-3">₹ 89,990,000</td>
          <td className="p-3">April 5, 2025</td>
...
<div className="bg-[#1B2735] p-6 rounded-lg text-white">
  ...
  <div className="border border-gray-600 rounded-md overflow-hidden">
    <table className="w-full text-left text-sm">
      <thead className="bg-[#1B2735] text-gray-400">
        <tr className="border-b border-gray-600">
          <th className="p-3">Name of Land Owner</th>
          <th className="p-3">Name of Buyer</th>
          <th className="p-3">Property Name</th>
          <th className="p-3">Rent Amount (monthly)</th>
          <th className="p-3">Security Deposit</th>
          <th className="p-3">Agreement Duration</th>
      ...
      <tbody className="bg-[#1B2735]">
        <tr className="border-b border-gray-700">
          ...
          <td className="p-3">Flat</td>
          <td className="p-3">₹ 45,280.67</td>
          <td className="p-3">₹ 89,990.00</td>
          <td className="p-3">Six months</td>
          <td className="p-3">April 5, 2025</td>
        </tr>
        <tr>
          <td className="p-3 font-medium">Mr. Bankim Doshi</td>
          ...
          <td className="p-3">₹ 45,280.67</td>
          <td className="p-3">₹ 89,990.00</td>
          <td className="p-3">Three months</td>
          <td className="p-3">April 5, 2025</td>
        </tr>
      </tbody>
    </table>
  ...
  <div className="border border-gray-600 rounded-md overflow-hidden">
    <table className="w-full text-left text-sm">
      <thead className="bg-[#1B2735] text-gray-400">
        <tr className="border-b border-gray-600">
          <th className="p-3">Name of Seller</th>
          <th className="p-3">Name of Builder</th>
          <th className="p-3">Property Type</th>
          <th className="p-3">Purchase Value</th>
          <th className="p-3">Property ID</th>
          <th className="p-3">Mode of Ownership</th>
...
<div className="border border-gray-400 rounded-md w-full bg-[#1E293B]">
  ...
  <div className="p-4 space-y-4 text-white rounded-b-md">
    <div className="flex items-center space-x-3">
      ...
      <span className="font-medium">Flat(50%)</span>
    </div>
    <div className="flex items-center space-x-3">
      <div className="w-6 h-6 rounded bg-[#F7B36B]" />
      <span className="font-medium">Land (25%)</span>
    </div>
    <div className="flex items-center space-x-3">
      <div className="w-6 h-6 rounded bg-[#F59C6B]" />
      <span className="font-medium">Villa (15%)</span>
    </div>
    <div className="flex items-center space-x-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      You've received rent for your Bandra Flat-₹20,000 on 12/04/2025.Keep track of your cash flow.
                    </p>
