...
const Propertyinsuranceinvestmentdetails = () => {
  ...
  return (
    <div className="flex w-screen max-w-full bg-gray-900 text-white h-screen overflow-hidden">
      ...
      <div className="flex flex-col flex-1 ml-60 h-full overflow-y-auto">
        ...
        {/* Page Content */}
        <div className="p-10">
          <h1 className="text-2xl font-bold mb-6">PROPERTY INSURANCE INVESTMENT DETAILS</h1>
...
export default Propertyinsuranceinvestmentdetails;
