    ...
    <div className="min-h-screen flex bg-[#0D1520] text-white">
      ...
      <div className="flex-1 ml-60 flex flex-col">
        ...
        <div className="p-6 w-full">
          <h1 className="text-2xl font-bold mb-6">PPF A/c. Nomination Details</h1>
          ...
          <div className="flex flex-wrap gap-4 mb-6">
            ...
            <div>
              <p className="mb-1 text-sm">Filter by Nominations</p>
            ...
            <table className="min-w-full text-sm text-left">
              ...
              <tbody>
                {nominations.map((nom, idx) => (
                  ...
                  >
                    <td className="px-4 py-2">{nom.bank}</td>
                    <td className="px-4 py-2">{nom.nominee}</td>
                    <td className="px-4 py-2">{nom.amount}</td>
                    <td className="px-4 py-2">{nom.opening}</td>
                    <td className="px-4 py-2">{nom.maturity}</td>
                    <td className="px-4 py-2">{nom.branch}</td>
                  </tr>
                ))}
              </tbody>
            </table>
