  ...
  return (
    <div className="flex w-screen max-w-full overflow-x-hidden bg-gray-900 text-white min-h-screen">
      ...
      <div className="flex flex-col flex-1 bg-gray-900 overflow-x-hidden ml-60">
        ...
        <div className="p-10">
          <h1 className="text-2xl font-bold mb-10">ADD VEHICLE INSURANCE DETAILS</h1>
          ...
          <form className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
            ...
            <div className="flex flex-col">
             ...
             <div className="flex flex-col">
              <label className="mb-1 text-sm font-medium">Vehicle Type</label>
              <select className="bg-[#1B2735] text-white p-3 rounded-lg">
                <option>Car</option>
              </select>
            </div>
            ...
            <div className="flex flex-col">
              <label className="mb-1 text-sm font-medium">Vehicle Registered Number</label>
              <input type="text" className="bg-[#1B2735] text-white p-3 rounded-lg" />
            </div>

             <div className="flex flex-col">
              <label className="mb-1 text-sm font-medium">Vehicle Make & Model</label>
              <input type="text" className="bg-[#1B2735] text-white p-3 rounded-lg" />
            </div>

             <div className="flex flex-col">
              <label className="mb-1 text-sm font-medium">Year of Manifacture</label>
              <select className="bg-[#1B2735] text-white p-3 rounded-lg">
                <option>Years</option>
              </select>
            </div>
            ...
            <div className="flex flex-col">
              <label className="mb-1 text-sm font-medium">Insured Declared Value(IDV)</label>
              <input type="text" className="bg-[#1B2735] text-white p-3 rounded-lg" />
            </div>

            <div className="flex flex-col">
              <label className="mb-1 text-sm font-medium">No Claim Bonus(NCB)</label>
              <input type="text" className="bg-[#1B2735] text-white p-3 rounded-lg" />
            </div>

             <div className="flex flex-col">
              <label className="mb-1 text-sm font-medium">Roadside Assistance Available</label>
              <select className="bg-[#1B2735] text-white p-3 rounded-lg">
                <option>Yes</option>
                <option>No</option>
              </select>
             ...
             <div className="flex flex-col">
              <label className="mb-1 text-sm font-medium">Zero Depreciation Cover</label>
              <select className="bg-[#1B2735] text-white p-3 rounded-lg">
                <option>No</option>
                <option>Yes</option>
              </select>
...
<div className="flex flex-col">
  <label className="mb-1 text-sm font-medium">Agent Advisor Name(if applicable)</label>
  <input type="text" className="bg-[#1B2735] text-white p-3 rounded-lg" />
</div>
