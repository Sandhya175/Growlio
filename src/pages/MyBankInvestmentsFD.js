...
<div className="flex flex-col gap-1 mb-4">
  ...
  {/* Dropdown for Account Holders */}
  <select className="p-2 bg-[#1B2735] border border-gray-600 rounded w-80 text-white mt-2">
  ...
  <p className="text-2xl font-semibold text-white mt-4">Investment Status</p>
</div>

            <div className="grid md:grid-cols-1 gap-4 mb-6 flex items-center">
              <div className="flex gap-4 items-center">
                <div className="bg-gray-800 p-3 rounded w-60 h-30 flex flex-col gap-2">
...
export default MyBankInvestmentsFD;
