...
const PPFAccountDetails = () => {
  ...
  const handleDownloadPDF = () => {
    alert("Download PDF clicked!"); // You can replace this with actual logic
  };
  ...
  return (
    <div className="min-h-screen flex bg-[#0D1520] text-white">
      ...
      <div className="flex-1 ml-60 flex flex-col">
        ...
        {/* Main Content */}
        <div className="p-6">
          <h1 className="text-2xl font-bold mb-6">PPF A/c. Details</h1>
              ...
              <tbody>
                {accounts.map((acc, idx) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-2">{acc.maturity}</td>
