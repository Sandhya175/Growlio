        ...
        <div className="px-8 py-6 space-y-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              />
              <h2 className="text-2xl font-bold text-white">Axis Bank</h2>
            </div>
          </div>
...
<div className="relative w-96">
  ...
  >
    {Object.entries(investorRoles).map(([name, role]) => (
...
<div>
  ...
  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
    {[
      { label: "Linked Bank Accounts", amount: "₹ 15,00,000", subtitle: "15 Bank Accounts", color: "bg-blue-500"},
      { label: "On Hold", amount: "₹ 20,00,000", subtitle: "12 Investments", color: "bg-teal-500", },
      { label: "Matured", amount: "₹ 2,00,000", subtitle: "8 Investments", color: "bg-yellow-500" },
      { label: "Withdrawn", amount: "₹ 5,00,000", subtitle: "4 Investments", color: "bg-pink-500" }
    ].map((item, idx) => (
      <div
        key={idx}
