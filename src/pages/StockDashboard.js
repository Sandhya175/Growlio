   ...
   {/* Main Content */}
      <div className="flex-1 flex flex-col bg-gray-900 overflow-x-hidden overflow-y-auto h-screen ml-60">
        ...
        <div className="flex-1 p-6 space-y-6">
          <h1 className="text-2xl font-bold"> MY STOCK INVESTMENTS </h1>
    ...
    <table className="w-full text-left text-sm">
      <thead className="bg-[#1B2735] text-gray-400">
        <tr className="border-b border-gray-600">
          ...
          <th className="p-3">Total Purchase Value</th>
      ...
      <tbody className="bg-[#1B2735]">
        ...
        <tr>
          ...
          <td className="p-3">₹ 190.89</td>
          <td className="p-3">₹ 70,000.00</td>
          <td className="p-3">₹ 77,909.00</td>
          <td className="p-3">₹ 189.89</td>
        </tr>
      </tbody>
    ...
    <table className="w-full text-left text-sm">
      <thead className="bg-[#1B2735] text-gray-400">
        <tr className="border-b border-gray-600">
          ...
          <th className="p-3">Trader Date</th>
          <th className="p-3">Account Number</th>
          <th className="p-3">Trade Type</th>
      ...
      <tbody className="bg-[#1B2735]">
        <tr className="border-b border-gray-700">
          <td className="p-3 font-medium">Mr. Bankim Doshi</td>
          <td className="p-3">09/08/2024</td>
          <td className="p-3">74983298202</td>
          <td className="p-3">Buy</td>
          <td className="p-3">Regular</td>
          <td className="p-3">09:22</td>
        </tr>
        <tr>
          <td className="p-3 font-medium">Mr. Bankim Doshi</td>
          <td className="p-3">09/08/2024</td>
    ...
    <table className="w-full text-left text-sm">
      <thead className="bg-[#1B2735] text-gray-400">
        <tr className="border-b border-gray-600">
          ...
          <th className="p-3">Premium Paid</th>
        </tr>
      </thead>
      <tbody className="bg-[#1B2735]">
        <tr className="border-b border-gray-700">
          <td className="p-3 font-medium">Future & Options</td>
          <td className="p-3">₹ 7,000.00</td>
          <td className="p-3">Call</td>
          <td className="p-3">09/08/2024</td>
  ...
  <div className="border border-gray-400 rounded-md w-full bg-[#1E293B]">
    ...
    <div className="p-4 space-y-4 text-white rounded-b-md">
      <div className="flex items-center space-x-3">
        ...
        <span className="font-medium">Technology (28%)</span>
      </div>
      <div className="flex items-center space-x-3">
        <div className="w-6 h-6 rounded bg-[#F7B36B]" />
        <span className="font-medium">Healthcare (18%)</span>
      </div>
      <div className="flex items-center space-x-3">
        <div className="w-6 h-6 rounded bg-[#F59C6B]" />
        <span className="font-medium">Financials (12%)</span>
      </div>
      <div className="flex items-center space-x-3">
        <div className="w-6 h-6 rounded bg-[#63A9E0]" />
        <span className="font-medium">Consumer Goods (32%)</span>
      </div>
      <div className="flex items-center space-x-3">
        <div className="w-6 h-6 rounded bg-[#5A5CE8]" />
        <span className="font-medium">Energy (7%)</span>
      </div>
      <div className="flex items-center space-x-3">
